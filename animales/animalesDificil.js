...
// Opciones de palabras para animales (nivel difícil) con pistas
const opciones = [
  { palabra: "Ornitorrinco", pista: "Animal con pico de pato y cuerpo de nutria" },
  { palabra: "Quetzal", pista: "Ave con plumaje brillante de América Central" },
  { palabra: "Okapi", pista: "Animal con cuerpo de cebra y cabeza de jirafa" },
  { palabra: "Axolotl", pista: "Salamandra mexicana que nunca completa su metamorfosis" },
  { palabra: "Narval", pista: "Ballena unicornio con colmillo largo y retorcido" },
  { palabra: "Blobfish", pista: "Pez de aguas profundas con aspecto gelatinoso" }
];
