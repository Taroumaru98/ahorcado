...
// Opciones de palabras para animales (nivel medio) con pistas
const opciones = [
  { palabra: "Leopardo", pista: "Felino manchado de África y Asia" },
  { palabra: "Panda", pista: "Oso blanco y negro de China" },
  { palabra: "Jaguar", pista: "Gran felino de América con manchas" },
  { palabra: "Canguro", pista: "Mamífero marsupial saltador de Australia" },
  { palabra: "Suricata", pista: "Pequeño mamífero de África conocido por su vigilancia" },
  { palabra: "Nutria", pista: "Animal acuático con pelaje denso y cola musculosa" }
];
