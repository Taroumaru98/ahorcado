...
// Opciones de palabras para animales (nivel fácil) con pistas
const opciones = [
  { palabra: "Perro", pista: "Animal doméstico amigo del hombre" },
  { palabra: "Gato", pista: "Animal felino independiente" },
  { palabra: "Elefante", pista: "Mamífero terrestre de gran tamaño" },
  { palabra: "Pato", pista: "Ave acuática que grazna" },
  { palabra: "Tigre", pista: "Gran felino rayado de Asia" },
  { palabra: "Oso", pista: "Gran mamífero plantígrado" }
];
