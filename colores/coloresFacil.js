...
// Opciones de palabras para colores (nivel fácil) con pistas
const opciones = [
  { palabra: "Rojo", pista: "Color de la sangre y el fuego" },
  { palabra: "Azul", pista: "Color del cielo despejado" },
  { palabra: "Verde", pista: "Color de la naturaleza y la esperanza" },
  { palabra: "Amarillo", pista: "Color brillante como el sol" },
  { palabra: "Blanco", pista: "Color de la nieve y la pureza" },
  { palabra: "Negro", pista: "Ausencia de color, como la noche" }
];
