...
// Opciones de palabras para colores (nivel medio) con pistas
const opciones = [
  { palabra: "Magenta", pista: "Color parecido al púrpura intenso" },
  { palabra: "Turquesa", pista: "Color que mezcla verde y azul" },
  { palabra: "Carmesi", pista: "Rojo profundo y brillante" },
  { palabra: "Ambar", pista: "Color dorado anaranjado como la resina" },
  { palabra: "Ocre", pista: "Color terroso entre amarillo y marrón" },
  { palabra: "Coral", pista: "Color rosado anaranjado como los corales marinos" }
];
