...
// Opciones de palabras para países (nivel medio) con pistas
const opciones = [
  { palabra: "Alemania", pista: "País en Europa conocido por la cerveza y la Oktoberfest" },
  { palabra: "Canada", pista: "País en América del Norte famoso por sus paisajes naturales y hockey" },
  { palabra: "India", pista: "País en Asia conocido por el Taj Mahal y el curry" },
  { palabra: "Egipto", pista: "País en África famoso por las pirámides y el río Nilo" },
  { palabra: "Brasil", pista: "País sudamericano conocido por el fútbol y el carnaval" },
  { palabra: "Italia", pista: "País europeo famoso por la pasta, la pizza y el Coliseo" }
];
...
let palabraElegida = "";
let tiempoRestante = 45; // Tiempo para nivel medio
