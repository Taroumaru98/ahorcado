...
// Opciones de palabras para países (nivel difícil) con pistas
const opciones = [
  { palabra: "Kiribati", pista: "País insular en el océano Pacífico con muchas islas" },
  { palabra: "Luxemburgo", pista: "País europeo pequeño conocido por su alta calidad de vida" },
  { palabra: "Yibuti", pista: "País en el Cuerno de África con acceso al mar Rojo" },
  { palabra: "Liechtenstein", pista: "País europeo en los Alpes conocido por su bajo nivel de desempleo" },
  { palabra: "Surinam", pista: "País sudamericano con selvas tropicales y diversidad étnica" },
  { palabra: "Comoras", pista: "Archipiélago en el océano Índico conocido por su biodiversidad marina" }
];
